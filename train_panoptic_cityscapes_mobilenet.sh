...
--epochs 100 \
--batch-size 2 \
--checkname panoptic-deeplab-mobilenet-test \
--eval-interval 1 \
--task panoptic \
--resume /home/tjosh/codes/pytorch-deeplab-xception/run/cityscapes/panoptic-deeplab-mobilenet-dsc-1/model_best.pth.tar \
--dataset cityscapes
